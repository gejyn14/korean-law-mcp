...
| **전문: 특별행정심판** `NEW` | 4 | `search_acr_special_appeals`, `search_appeal_review_decisions` |
| **법령-자치법규 연계** `NEW` | 4 | `get_linked_ordinances`, `get_delegated_laws` |
| **조약** `NEW` | 2 | `search_treaties`, `get_treaty_text` |
| **학칙/공단/공공기관** `NEW` | 6 | `search_school_rules`, `search_public_corp_rules`, `search_public_institution_rules` |
...
전체 도구 목록은 [영문 README](./README.md#tool-categories-87-total) 참조.
